HTML5GameTemplate & <br />JavaScript: The Good Parts
====
...
---
#### Jasmine Unit Tests
This is a good intro & reference: [Jasmine Introduction](http://jasmine.github.io/2.0/introduction.html)

#### What the template code gives you
HTML5 Boilerplate is a simple example of Test Driven game-like behavior
implemented in Javascript using a functional object creation pattern (as described in *Javascript: the Good Parts, Chapter 5*).
